  ...
  <div class="grid gap-5 sm:grid-cols-3 lg:grid-cols-6">
    <div class="bg-red-50 rounded-xl p-5 cursor-pointer items-center justify-center flex" @click="linkEpsi()">
      ...
      <div class="ml-2 mt-2 flex flex-col">
        <h1 class="text-sm text-red-700 font-medium">EPSI</h1>
    ...
    <div class="bg-yellow-50 rounded-xl p-5 cursor-pointer items-center justify-center flex" @click="linkWis()">
      ...
      <div class="ml-2 mt-2 flex flex-col">
        <h1 class="text-sm text-yellow-700 font-medium">WIS</h1>
        <external-link-icon-o class="w-4 h-4 text-gray-600 group-hover:text-gray-800" />
      </div>
    </div>
    ...
    <div class="bg-purple-50 rounded-xl p-5 cursor-pointer items-center justify-center flex" @click="linkDiscord()">
      <svg width="60" height="35" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    ...
    linkDiscord() {
      alert("Les inscriptions se font par mail. Veuillez contacter contact@discord.epsiwis.fr");
    },
    linkTeams() {
